...
# commit_sha=' %{$FG[243]%}‹sha:$(commit_sha)›%{$reset_color%}'
...
PROMPT="╭─%{$FG[040]%}%n%{$reset_color%} %{$FG[239]%}in%{$reset_color%} %{$terminfo[bold]$FG[226]%}${current_dir}%{$reset_color%}${git_info} %{$FG[239]%}@${go_ver}
